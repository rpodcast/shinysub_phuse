...
hex_dir <- file.path(here::here(), "positslides_shiny_phuse", "images", "hex")
...
image_write(final_image, file.path(here::here(), "positslides_shiny_phuse", "images", "pilot2_packages.png"))
