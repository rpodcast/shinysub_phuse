...
subtitle: "Eric Nantz & Phil Bowsher March 8, 2023 RinPharma.com"
...
- Challenge - Modernize the clinical trials process with interactive capablities
...
- Dive deeper into datapoints via hyperlinking or mouse overs
...
- “Replacing a static submission with a dynamic one that allows for custom and flexible reports and visualisations would be a major improvement for reviewers, not only for verifying the safety and efficacy of a product, but also for expanding on the analysis already done by the sponsor”
...
Universites & Students use Shiny
...
[The](https://www.lexjansen.com/phuse-us/2022/os/PRE_OS07.pdf) industry effort in building, collaborating & design new R-packages, brings new capabilities & possibly triggering further downstream changes
